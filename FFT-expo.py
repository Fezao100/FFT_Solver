...
n_amostras = 1024 #Número de amostras para o calculo do FFT que queremos (pode ser qualquer potencia de 2, porem quanto maior melhor)
t = np.linspace(-20,20,n_amostras)
...
freq_aq = 1024 #Frêquencia na qual o sinal de entrada foi adquirido
